...
import com.mshernandez.vertconomy.core.response.VertconomyWithdrawRequestResponse;
import com.mshernandez.vertconomy.core.response.WithdrawRequestResponse;
import com.mshernandez.vertconomy.core.response.WithdrawRequestResponseType;
...
public class WithdrawService
{
    ...
    public WithdrawRequestResponse initiateWithdraw(UUID initiatorId, String destAddress, long amount)
    {
        ...
        if (SUS_PATTERN.matcher(destAddress).matches())
        {
            ...
            return new VertconomyWithdrawRequestResponse(WithdrawRequestResponseType.INVALID_ADDRESS);
        }
        // Make Sure No Existing Request Already Exists
        if (initiator.getWithdrawRequest() != null)
        {
            return new VertconomyWithdrawRequestResponse(WithdrawRequestResponseType.REQUEST_ALREADY_EXISTS);
        }
        // Begin Withdraw
        ...
        {
            return new VertconomyWithdrawRequestResponse(WithdrawRequestResponseType.NOT_ENOUGH_WITHDRAWABLE_FUNDS);
        }
        ...
        try
        {
            ...
            {
                return new VertconomyWithdrawRequestResponse(WithdrawRequestResponseType.CANNOT_AFFORD_FEES);
            }
