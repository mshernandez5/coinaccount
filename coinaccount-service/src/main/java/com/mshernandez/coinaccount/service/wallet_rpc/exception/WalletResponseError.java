 ...
 * </a>.
 */
public enum WalletResponseError
{
    // General Errors
    RPC_MISC_ERROR(-1),
    ...
    private WalletResponseError(int errorCode)
    {
    ...
    private static final Map<Integer, WalletResponseError> codeMap = new HashMap<>();

    static
    {
        for (WalletResponseError e : values())
        {
     ...
     */
    public static WalletResponseError find(int errorCode)
    {
